...
function (_React$Component) {
  _inherits(D3MapRenderer, _React$Component);

  function D3MapRenderer() {
    _classCallCheck(this, D3MapRenderer);

    return _possibleConstructorReturn(this, _getPrototypeOf(D3MapRenderer).apply(this, arguments));
  }

  _createClass(D3MapRenderer, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (currentRidingId && currentRidingId > -1 && currentRidingId !== prevProps.currentRidingId) {
        ...
        for (var i = 0; i < paths._groups[0].length; i += 1) {
          ...
          var node = paths._groups[0][i];

          if (Number(node.id) + e6nHardcodedRidingIdFix === currentRidingId) {
            currentId = Number(node.id); // eslint-disable-next-line no-underscore-dangle
    ...
    value: function render() {
      var _this$props2 = this.props,
          ...
          setCurrentRidingAction = _this$props2.setCurrentRiding,
          styledComponents = _this$props2.styledComponents,
          E6N_PAGE_IDS = _this$props2.E6N_PAGE_IDS;
      var partyColors = [];

      if (allParties) {
        var allPartiesArray = Object.values(allParties);

        for (var i = 0; i < allPartiesArray.length; i += 1) {
          var colorString = ".s".concat(allPartiesArray[i].id, " { fill: ").concat(allPartiesArray[i].color, ";}");
          partyColors.push(colorString);
        }
      }

      return React.createElement(D3MapRendererModule, {
...
var StyledSvg = null;
var StyledCanvas = null;

var D3MapRendererModule =
/*#__PURE__*/
function (_React$Component) {
  _inherits(D3MapRendererModule, _React$Component);

  function D3MapRendererModule(props) {
    var _this;

    _classCallCheck(this, D3MapRendererModule);
    ...
    StyledSvg = styled.svg(_templateObject(), colorsUi.lightgrey, mediaQueries.mediaMax(bp.SM.max, "\n        stroke-width: 0.05px;\n      "), function (_ref) {
      var partyColors = _ref.partyColors;

      if (partyColors) {
        var styles = '';
        partyColors.forEach(function (element) {
          styles += "".concat(element, " ");
        });
        return css(_templateObject2(), styles);
      }

      return null;
    }, colorsUi.lightgrey);
    StyledCanvas = styled.canvas(_templateObject3());
    return _this;
  }

  _createClass(D3MapRendererModule, [{
  ...
  _createClass(D3Map, [{
    ...
    value: function componentDidUpdate() {
      if (this.featuresGlobal) {
        ...
        for (var i = 0; i < childNodes.length; i += 1) {
          ...
          var partyColor = this.fillRidingsWithLeadingPartyColor(Number.parseInt(childNode.id, 10));

          if (partyColor) {
            var attributes = childNode.getAttribute('class');
            childNode.setAttribute('class', classNames("".concat(partyColor), {
    ...
    value: function onMouseMove(event) {
      if (event && event.nativeEvent && this.childTooltipRef && this.childTooltipRef.current) {
        this.childTooltipRef.current.style.left = "".concat(String(event.nativeEvent.layerX + 20), "px");
        this.childTooltipRef.current.style.top = "".concat(String(event.nativeEvent.layerY + 12), "px");
      }
    }
  }, {
    ...
    value: function focusOnRiding(feature, id) {
      ...
      for (var k = 0; k < featureGroup._groups[0].length; k += 1) {
        // eslint-disable-next-line no-underscore-dangle
        var node = featureGroup._groups[0][k];

        if (node.className.baseVal.indexOf('flash-it') > -1) {
          var currentClasses = node.className.baseVal;
        ...
        var equivalency = Number(node.id);
    ...
    value: function zoomed() {
      ...
      if (allowZoom) {
        this.featuresGlobal.attr('transform', window.d3.event.transform).selectAll('path').style('stroke-width', "".concat(1 / (window.d3.event.transform.k * 6), "px")); // updated for d3 v4
      }
    }
  }, {
    ...
    value: function zoomEnd() {
      ...
      this.featuresGlobal.selectAll('path').style('stroke-width', "".concat(1 / (window.d3.event.transform.k * 6), "px"));
      this.setState({
        currentPan: {
    ...
    value: function loadMaps(mapDOMId) {
      ...
      var projectionModel = mapData.projectionModel ? mapData.projectionModel : 'geoMercator'; // Map projection
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VIEWPORT_BREAKPOINT_NAMES", function() { return VIEWPORT_BREAKPOINT_NAMES; });
/* ATTENTION !!!
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "colorsDx", function() { return colorsDx; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "colorsDxRgb", function() { return colorsDxRgb; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "colorsUi", function() { return colorsUi; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "colorsTxt", function() { return colorsTxt; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "colorsBrands", function() { return colorsBrands; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "colorsPalette", function() { return colorsPalette; });
var colorsDx = {
  black: '#000000',
  blue: '#006699',
  blueLight: '#edf4f8',
...
var colorsUi = {
  ...
  yellow: '#f7f700',
  // Blacks
  black08: "rgba(".concat(colorsDxRgb.black, ", .08)"),
  black10: "rgba(".concat(colorsDxRgb.black, ", .1)"),
  black20: "rgba(".concat(colorsDxRgb.black, ", .2)"),
  black40: "rgba(".concat(colorsDxRgb.black, ", .4)"),
  black60: "rgba(".concat(colorsDxRgb.black, ", .6)"),
  black70: "rgba(".concat(colorsDxRgb.black, ", .7)"),
  black80: "rgba(".concat(colorsDxRgb.black, ", .8)"),
  // Whites
  white08: "rgba(".concat(colorsDxRgb.white, ", .08)"),
  white16: "rgba(".concat(colorsDxRgb.white, ", .16)"),
  white80: "rgba(".concat(colorsDxRgb.white, ", .8);"),

  /* Dégradé */
  gradient04: "linear-gradient(to bottom, rgba(".concat(colorsDxRgb.black, ", 0) 0%, rgba(").concat(colorsDxRgb.black, ", .04) 100%);"),
  gradient04top: "linear-gradient(to top, rgba(".concat(colorsDxRgb.black, ", 0) 0%, rgba(").concat(colorsDxRgb.black, ", .04) 100%);"),
  gradient08: "linear-gradient(to bottom, rgba(".concat(colorsDxRgb.black, ", 0) 0%, rgba(").concat(colorsDxRgb.black, ", .08) 100%);")
};
var colorsTxt = {
  DXB4: '#b4b4b4',
  DX2: '#222',
...
var colorsPalette = {
  colorsBrands: colorsBrands,
  colorsDx: colorsDx,
  colorsDxRgb: colorsDxRgb,
  colorsTxt: colorsTxt,
  colorsUi: colorsUi
};
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (immutable) */ __webpack_exports__["mediaMin"] = mediaMin;
/* harmony export (immutable) */ __webpack_exports__["mediaMax"] = mediaMax;
/* harmony export (immutable) */ __webpack_exports__["mediaMinMax"] = mediaMinMax;
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mediaQueries", function() { return mediaQueries; });
function mediaMin(breakpoint, rules) {
  return "\n      @media (min-width: ".concat(breakpoint, "px) {\n        ").concat(rules, "\n      }\n    ");
}
function mediaMax(breakpoint, rules) {
  return "\n      @media (max-width: ".concat(breakpoint, "px) {\n        ").concat(rules, "\n      }\n    ");
}
function mediaMinMax(breakpointMin, breakpointMax, rules) {
  return "\n      @media (min-width: ".concat(breakpointMin, "px) and (max-width: ").concat(breakpointMax, "px) {\n        ").concat(rules, "\n      }\n    ");
}
var mediaQueries = {
  mediaMin: mediaMin,
  mediaMax: mediaMax,
  mediaMinMax: mediaMinMax
};
