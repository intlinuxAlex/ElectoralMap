...
//import React, { Component } from 'react'; // require
const React = require('react');
const Component = require('react');
//import classNames from 'classnames/dedupe'; // require
const classNames = require('classnames/dedupe');
const D3MapRenderer = require('./D3MapRenderer'); // sortir
const D3MapZoomButton = require( './D3MapZoomButton'); // sortir

//const global = require('styled-components');
//import { E6N_PAGE_IDS, e6nHardcodedRidingIdFix } from 'containers/pages/E6N/constants'; //envoyer les constantes en props a partir de V5. 

//import loadScript from 'lib/helpers/dynamicLibs'; // importer dynamicLibs dans ma librairie. PASTE si on est les seuls user
const loadScript = require('../lib/helpers/dynamicLibs');

//import { global } from 'lib/styled/global'; // envoyer en PROPS a partir de V5 ...

//import E6NToolTip from 'containers/modules/e6n/E6NToolTip'; // envoyer le container en PROPS a partir de V5. 
...
class D3Map extends Component { // eslint-disable-line react/prefer-stateless-function
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    (async () => {
      if (!window.d3) {
        ...
        await loadScript(d3SourceScript);
        window.define = tmpFn;
      }
  ...
  render() {
    ...
    console.log("BOUBA!!!!!!!!");
    const StyledMap = global.styled.div`
      flex-grow: 1;
      position: relative;

      ${mediaMax(global.bp.SM.max, `
        height: 45vh;
      `)}
      ...
      ` : '')}
    `;
   console.log("enigme in a bottle");
    return (
      <span>
          Si un jour les oiseaux.
      </span>    
    );/*
    return (
      <StyledMap
